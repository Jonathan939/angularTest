...
(function () {
  ...
  describe('Data Servicee', function() {
    ...
    beforeEach(angular.mock.inject(function GetDependencies(_dataService_, $q, _$rootScope_) {
      ...
      // set up the working API return, now that Promises ($q) is available
